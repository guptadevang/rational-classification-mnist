...
plt.title(r'$\alpha$ Values vs Convergence (Time)')
plt.legend()
plt.grid(True)
...
plt.title(r'$\alpha$ Values vs No. of Iterations')
plt.legend()
plt.grid(True)
...
plt.title(R'$\alpha$ Values vs MSE')
plt.legend()
plt.grid(True)
...
plt.title(r'$\alpha$ Values vs SSE')
plt.legend()
plt.grid(True)
